      ...
      <div className="w-[80%]  mx-auto flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex flex-col justify-between gap-2 h-full w-full">
          ...
          <div className="imgdiv">
            <Image className="w-[100%] mt-2 md:mt-14" src={imageSrc2} alt={imageAlt2} width={200} height={200} />
          </div>
        </div>

        {/* Second Column: Divider */}
        <div className="hidden md:flex justify-center w-[40%]">
          <Image src={dividerImageSrc} alt="Divider" className="h-80 w-auto" width={200} height={200}  />
        </div>
        ...
        <div className="flex flex-col gap-4 w-full">
          ...
          <div className="imgdiv w-full mt-4 md:mt-0">
            <Image src={imageSrc1} alt={imageAlt1} className="w-full" width={200} height={200}  />
          </div>
          {/* Text Content */}
          <div>
              ...
              {testTypes.map((testType, index) => (
                <div key={index} className="flex items-center gap-4 w-full">
                  <div className=" bg-[#FCE7D2] p-2 rounded-full shadow-md">
                    <Image src={testType.icon} alt={testType.title} width={30}  height={30} />
                  </div>
