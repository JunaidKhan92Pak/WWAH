...
//   const [contextLoading, setContextLoading] = useState(true); // Add this state
...
//   useEffect(() => {
//     // Preload user context when chat page loads
//     preloadUserContext();
//   }, [user?._id]); // Add user ID as dependency

//   const preloadUserContext = async () => {
//     if (!user?._id) return; // Don't preload if no user
...
//     } finally {
//       setContextLoading(false); // Update context loading state
//     }
//   };
...
//   // Show loading state while context is being preloaded
//   if (contextLoading) {
//     return (
...
//                       Ready to help with your education journey!
//                     </p>
