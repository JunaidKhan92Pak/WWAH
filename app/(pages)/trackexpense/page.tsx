...
// const images = [
//   { src: "/United Kingdom.png", name: "UK", alt: "United Kingdom" },
...
//                       <div className="flex justify-center">
//                         <Image
//                           src="/trackexpense/calculator.svg"u8
//                           alt="Calculator Illustration"
//                           width={200}
//                           height={200}
//                           className="object-contain"
...
import { PiPersonSimpleCircleLight } from "react-icons/pi";
import Image from "next/image";
@@ -17,10 +23,9 @@ import { BsBagCheck } from "react-icons/bs";
import { TbCloudStorm } from "react-icons/tb";
import { IoDiamondOutline } from "react-icons/io5";
...
const images = [
  ...
  { src: "/australia.png", name: "Australia", alt: "Australia" },
  { src: "/china.png", name: "China", alt: "China" },
@@ -55,10 +60,24 @@ interface BreakdownItemProps {
  bgColor: string;
  currency: string;
}
const BreakdownItem: React.FC<BreakdownItemProps> = ({
  ...
  <div className="flex-shrink-0 w-[calc(100%/3)] sm:w-auto flex flex-col items-center text-left md:text-center rounded-lg">
    ...
    <p className="font-bold mt-2">{label}</p>
    <p className="text-justify lg:text-center leading-4 md:leading-5 text-sm lg:text-md">
@@ -68,7 +87,8 @@ const BreakdownItem: React.FC<BreakdownItemProps> = ({ iconSrc, label, cost, bgC
);
