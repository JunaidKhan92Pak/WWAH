...
const images = [
  { src: "/uk.png", name: "UK", alt: "United Kingdom" },
  { src: "/usa.png", name: "USA", alt: "USA" },
  ...
  { src: "/italy.png", name: "Italy", alt: "Italy" },
  { src: "/malaysia.png", name: "Malaysia", alt: "Malaysia" },
  { src: "/france.png", name: "France", alt: "France" },
];
...
const BreakdownItem: React.FC<BreakdownItemProps> = ({ iconSrc, label, cost, bgColor, currency }) => (
  <div className="flex-shrink-0 w-[calc(100%/3)] sm:w-auto flex flex-col items-center text-left md:text-center rounded-lg">
    <div className={`p-4 sm:px-12 sm:py-6 md:px-6 lg:px-8 xl:px-10 lg:py-8 rounded-xl ${bgColor}`}>
      <Image src={iconSrc} alt={label} width={300} height={300} className="h-6 w-6 md:w-6 md:h-6" />
    </div>
        ...
        >
          <div className="w-4/5 text-left my-5">
            <div className="md:w-3/5 flex flex-col">
              ...
              <p className="py-2">
                Get complete estimates and budget smartly for housing, food, travel, and more.
              </p>
          ...
          <div className="w-full min-h-screen bg-[#FCE7D2] relative lg:px-8">
            ...
            <div className="relative z-10 flex flex-col md:flex-row gap-8 w-full mx-auto p-6">
              <div className="w-full md:w-[50%] md:space-y-2">
                    ...
                    <Carousel opts={{ align: "start" }} className="w-full p-2">
                      <CarouselContent>
                        {images.map((image, index) => (
                          <CarouselItem key={index} className="basis-1/4 md:basis-1/4 lg:basis-1/6 2xl:basis-1/12">
                              ...
                              <div className="flex flex-col items-center">
                                <div className="w-[60px] flex justify-center items-center">
                                  <Image
                                    ...
                                    width={200}
                                    height={200}
                                    onClick={() => handleSelectCountry(image.name)}
                      ...
                      {filteredUniversities.length > 0 ? (
                        filteredUniversities.map((uni, index) => (
                          <li
                            ...
                            onClick={() => handleSelectUniversity(uni.university_name)}
                          >
                ...
                {/* Accommodation Type */}
                <div>
                  <h5 className="text-gray-800 mb-2 mt-4">Accommodation Type</h5>
                  <div className="grid grid-cols-2 gap-6">
                    <button className="flex flex-col items-center px-6 py-4 border border-gray-300 rounded-lg hover:bg-gray-100">
                      ...
                      <div className="flex flex-col items-center">
                        ...
                        <p className="text-gray-700 font-normal">Accommodation</p>
                      </div>
                    </button>
                    <button className="flex flex-col items-center px-6 py-4 border border-gray-300 rounded-lg hover:bg-gray-100">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    {expenses &&
                      expenses[0]?.lifestyles.map((lifestyle: { type: keyof typeof lifestyleIcons }) => {
