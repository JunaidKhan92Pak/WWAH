...
export const FeeAndScholarships = ({ data }: FeeAndScholarshipsProps) => {
    ...
    return (
        <section className=" w-[90%] mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[25%_25%_50%] gap-2 md:gap-6">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 leading-normal lg:leading-10">
                            <li className="flex items-center space-x-2 ">
                                ...
                                <p className="font-semibold">{data.annual_tuition_fee.currency} {data.annual_tuition_fee.amount}</p>
                    ...
                    <div>
                        ...
                        <div className="flex items-start space-x-2 pb-4">
                            ...
                            <p className="text-gray-600 mb-4 leading-tight">
                                For overseas students, {data.universityname} provides a variety of scholarships
