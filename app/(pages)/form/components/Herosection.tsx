...
const Herosection = () => {
  return (
    <section className="mx-auto w-[90%] md:w-[95%] overflow-hidden mt-4">
      ...
      >
        <div className="w-full md:w-[60%] lg:w-[40%] px-4 md:pl-20 text-left">
          ...
          <div className="flex flex-col md:flex-row gap-2 md:gap-4 justify-center md:justify-start items-start md:items-start">
            <Link href="#book-demo">
              <Button className="bg-[#C7161E] rounded-lg text-white hover:bg-red-500 transition px-4 py-2 w-40 md:w-auto md:px-12 md:py-6 2xl:px-20 2xl:py-10 2xl:text-2xl">
                Register Now
              </Button>
            </Link>
            <Link href="#book-demo">
              <Button className="bg-white bg-opacity-20 text-white rounded-lg hover:bg-gray-200 hover:text-black transition px-8 py-2 w-40 md:w-auto md:px-12 md:py-6  2xl:px-20 2xl:py-10 2xl:text-2xl border border-transparent">
                Book a Free Demo
              </Button>
            </Link>
          </div>
