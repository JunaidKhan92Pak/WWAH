...
const Herosection = () => {
  return (
    <section className="mx-auto w-[90%] overflow-hidden mt-4">
      {/* Hero Section */}
      <div
        className="relative h-[200px] md:h-[80vh] flex flex-col justify-center items-center md:items-start text-white bg-cover bg-center rounded-3xl py-4 sm:p-0"
        style={{
      ...
      >
        <div className="w-full md:w-[60%] lg:w-[40%] px-4 md:pl-20 text-center md:text-left">
          ...
          <p className="md:mb-6 my-2">Book IELTS | PTE | TOEFL classes with WWAH</p>
