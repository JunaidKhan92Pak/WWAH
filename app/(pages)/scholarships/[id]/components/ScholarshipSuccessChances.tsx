...
export const ScholarshipSuccessChances = () => {
  const academicFactors = [
    { label: "Degree", value: 30, icon: "/degree-icon.svg" },
    { label: "Major/Discipline", value: 80, icon: "/major-icon.svg" },
    { label: "Grades", value: 45, icon: "/grade-icon.svg" },
  ...
  const financialFactors = [
    { label: "Tuition Fee", value: 40, icon: "/work-icon.svg" },
    { label: "Cost of Living", value: 50, icon: "/Tea-Cup.svg" },
  ];
