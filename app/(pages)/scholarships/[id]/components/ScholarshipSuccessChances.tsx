...
export const ScholarshipSuccessChances = () => {
    const academicFactors = [
        { label: "Degree", value: 30, icon: "/degree-icon.png" },
        { label: "Major/Discipline", value: 80, icon: "/major-icon.png" },
        { label: "Grades", value: 45, icon: "/grade-icon.png" },
        { label: "Work Experience", value: 50, icon: "/work-icon.png" },
        { label: "English Proficiency", value: 60, icon: "/lang-icon.png" },
    ];

    const financialFactors = [
        { label: "Tuition Fee", value: 40, icon: "/fee-icon.png" },
        { label: "Cost of Living", value: 50, icon: "/Tea-Cup.png" },
    ];
    ...
    return (
        <section className=" min-h-screen flex flex-col items-center justify-center p-4 sm:p-6">
            <h3 className="">Scholarship Success Chances!</h3>
            <p className="text-gray-600 mb-2">Your scholarship success chances are:</p>
            ...
            <div className="flex flex-col md:flex-row justify-center gap-8 w-full lg:w-[85%]">
                <div className="hidden md:flex items-center gap-4">
                    <p className="text-center">Academic Results <br /> 78%</p>
                        ...
                        <div key={index} className="mb-6">
                            <div className="relative w-full h-[4.7rem] rounded-2xl bg-[#f7f7f7] overflow-hidden flex items-center px-4">
                                <div
                                    ...
                                    style={{ width: `${item.value}%`, backgroundColor: getProgressBarColor(item.value) }}
                                >
                ...
                <div className="hidden md:flex items-center gap-4">
                    ...
                    <p className="text-center">Financial Results <br /> 60%</p>
                </div>
            </div>
        </section>
    );
