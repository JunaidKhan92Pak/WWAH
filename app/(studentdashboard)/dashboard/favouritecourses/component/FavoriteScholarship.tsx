      ...
      <div className="flex items-center justify-between mb-6">
        ...
        {favoriteList.length > 0 && (
          <button
            ...
            disabled={loading}
            className="px-4 py-2 text-sm bg-blue-500 hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-lg transition-colors duration-200 flex items-center gap-2"
          >
            <svg
