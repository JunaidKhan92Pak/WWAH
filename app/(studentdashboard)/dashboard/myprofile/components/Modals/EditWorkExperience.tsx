                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input placeholder="Enter job title..." className="bg-[#f1f1f1] placeholder-[#313131] placeholder:text-sm" {...field} />
                                </FormControl>
                                <FormMessage />
                              </FormItem>
                            )}
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl>
                                  <Input className="bg-[#f1f1f1] placeholder-[#313131] placeholder:text-sm" placeholder="Write..." {...field} />
                                </FormControl>
                                <FormMessage />
                                ...
                                <FormControl>
                                  <Popover>
                                    <PopoverTrigger asChild>
                                      <Button variant="outline" className="w-full text-left font-normal justify-start text-[#313131] bg-[#f1f1f1] placeholder-[#313131] placeholder:text-sm">
