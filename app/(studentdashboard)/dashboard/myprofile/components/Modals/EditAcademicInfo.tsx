...
const EditAcademicInfo = () => {
    ...
    const form = useForm({
        ...
        defaultValues: {
            ...
            subject: "Science",
            gradingScale: "Percentage Grade scale",
            obtainedScore: "65%",
            startDate: "",
            endDate: "",
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        // Add a slight delay to allow the first modal to close before opening the success modal
        setTimeout(() => {
            setSuccessOpen(true);
        }, 300);
    }
        ...
        <>
            ...
            <div className="flex flex-col items-start space-y-4">
                ...
                <div className="flex flex-row items-center gap-x-2">
                    <Image src="/DashboardPage/academic-cap.svg" alt="Icon" width={18} height={18} />
                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            >
                                                ...
                                                <SelectContent>
                                                    <SelectItem value="Percentage Grade scale">Percentage Grade Scale</SelectItem>
                                                    <SelectItem value="GPA Scale">GPA Scale</SelectItem>
                                                </SelectContent>
                                            </Select>
                                        </FormItem>
                                    )}
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input placeholder="Enter obtained score"
                                                    className="bg-[#f1f1f1] placeholder-[#313131] placeholder:text-sm"
                                                    {...field} />
                                            </FormControl>
                                        </FormItem>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 items-end">
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel>Which Standardized tests have you taken?</FormLabel>
                                            <Select onValueChange={field.onChange} defaultValue={field.value}>
                                                <SelectTrigger className="bg-[#f1f1f1] placeholder-[#313131] placeholder:text-sm"
                                                >
