            ...
            <div className="flex flex-col items-start">
                ...
                <div className="flex items-center">
                    <span className="text-sm relative">
                        {passwordVisible ? storedPassword : "*".repeat(storedPassword.length)}
                        <Button
                            type="button"
                            variant="ghost"
                            size="sm"
                ...
                <div className="flex flex-row items-center gap-x-2">
                    <Image src="/DashboardPage/key.svg" alt="Icon" width={18} height={18} />
            ...
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogContent className="!rounded-2xl  max-w-[300px] md:max-w-[500px]">
                    ...
                    <DialogHeader>
                        ...
                        <p className="text-sm text-gray-500">You can change your password once in 20 days.</p>
                    </DialogHeader>
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <PasswordInput
                                ...
                                togglePasswordVisibility={() => setPasswordVisible(prev => !prev)}  // Pass the togglePasswordVisibility prop
                            />

                            {passwordErrors.currentPassword && <p className="text-red-600 text-sm">{passwordErrors.currentPassword}</p>}
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                            <div>
                                ...
                                <PasswordInput
                                    ...
                                    togglePasswordVisibility={() => setNewPasswordVisible(prev => !prev)}
                                />
                            ...
                            <div>
                                ...
                                <PasswordInput
                                    ...
                                    togglePasswordVisibility={() => setConfirmPasswordVisible(prev => !prev)}
                                />
                                {passwordErrors.confirmPassword && <p className="text-red-600 text-sm">{passwordErrors.confirmPassword}</p>}
                            </div>
                        </div>

                        {/* Submit Button */}
                        <Button onClick={handleUpdatePassword} className="w-full md:w-[30%] bg-[#C7161E]">
                            Update Password
                        </Button>
                    </div>
                </DialogContent>
