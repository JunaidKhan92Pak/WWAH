...
const HeroSection: React.FC<HeroSectionProps> = ({ firstName, lastName }) => {

  const [coverPhoto, setCoverPhoto] = useState<string>('/DashboardPage/profileflow.svg');
  const [profilePic, setProfilePic] = useState<string>('/DashboardPage/group.svg');
  ...
  return (
    <div className="relative w-full md:w-[97%] mx-auto h-44 md:h-72 lg:h-96">
      ...
      <div className="absolute bottom-4 right-4">
        ...
        >
          <Image src="/DashboardPage/camera.svg" alt="Edit" width={25} height={25} />
        ...
        <div>
          ...
          <div className="flex flex-col  gap-2 ">
            <div className='md:block hidden'>
              ...
              <p className="text-base text-gray-600">Member since: {profile.membershipDate}</p>
            </div>
          </div>
        </div>
