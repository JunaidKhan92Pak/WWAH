...
export default function Home() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // fake API delay
    setTimeout(() => {
      console.log("Submitted Data:", formData); // <-- log data in console
      ...
      >
        ...
        <AccordionItem value="item-1" className="border rounded-lg">
          ...
          <AccordionContent className="px-4 pb-4 text-gray-600">
            The MBA program lets selected students represent WWAH, promote it
            through referrals, and earn exciting rewards.
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="item-2" className="border rounded-lg">
          ...
          <AccordionContent className="px-4 pb-4 text-gray-600">
            Go to the “Share & Earn” section on your dashboard to copy your
            link or download your QR code.
          </AccordionContent>
        </AccordionItem>
        ...
        <AccordionItem value="item-4" className="border rounded-lg">
          ...
          <AccordionContent className="px-4 pb-4 text-gray-600">
            All tracking is available in the “My Referrals” section of your
            dashboard.
          </AccordionContent>
        </AccordionItem>
        ...
        {showMore && (
          <>
            <AccordionItem value="item-5" className="border rounded-lg">
              ...
              <AccordionContent className="px-4 pb-4 text-gray-600">
                Any student currently registered with WWAH can apply to become
                a Mini Brand Ambassador.
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-6" className="border rounded-lg">
              ...
              <AccordionContent className="px-4 pb-4 text-gray-600">
                No, there is no limit — the more referrals you bring, the more
