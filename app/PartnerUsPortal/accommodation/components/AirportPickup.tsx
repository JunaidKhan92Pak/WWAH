...
/>
                ...
                <div>
                  ...
                  <Popover>
                    <PopoverTrigger asChild                       className="bg-gray-100 placeholder-[#313131] placeholder:text-sm "
>
                      <Button
                        id="student-status"
                        variant="outline"
          ...
          <Dialog>
            ...
            <DialogContent
              className="!rounded-2xl  max-w-[300px] md:max-w-[600px] max-h-[365px] md:max-h-[400px] xl:max-h-[535px] overflow-y-scroll"
              style={{ scrollbarWidth: "none", msOverflowStyle: "none" }}
            >
              <div>
  ...
  <SelectItem value="inr">INR - Indian Rupee</SelectItem>
        ...
        <Dialog open={open} onOpenChange={setOpen}>
                <DialogTrigger asChild>
                  <Button className="bg-[#FCE7D2] hover:bg-[#FCE7D2] text-black mt-4">
                    <FaPlaneDeparture className="mr-2" /> Add Flight Details
                  </Button>
                </DialogTrigger>
                <DialogContent className="!rounded-2xl max-w-[290px] md:max-w-[400px]  max-h-[285px] md:max-h-[350px] xl:max-h-[535px] overflow-y-scroll">
                  <DialogHeader>
...
/>
                  ...
                  <div className="flex justify-end gap-2 md:mt-4">
                    ...
                    <Button onClick={handleSave} className="bg-red-600 text-white hover:bg-red-700">Save</Button>
                  </div>
                </DialogContent>
              </Dialog>
          ...
          <table className="min-w-[1200px] w-full text-sm">
            <thead className="border-b">
              <tr>
                ...
                <th className="px-4 py-2 text-left">Airport Drop Off Location</th>
              ...
              <tr className="border-b">
                ...
                {Array.from({ length: 9 }).map((_, index) => (
                  <td key={index} className="px-4 py-4">
                    <Input className="h-8 w-24 bg-gray-100" />
                  </td>
                ))}
              </tr>
            </tbody>
