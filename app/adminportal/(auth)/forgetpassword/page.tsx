        ...
        <>
            ...
            >
                <div className="flex flex-col justify-center items-center text-center w-full p-4">
                    ...
                    <p className="w-full md:w-[45%] xl:w-[25%]">Please enter your registered email address below to initiate password reset request.</p>

                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 w-full md:w-[60%] lg:w-[40%] xl:w-[30%] mt-4">
                            {/* Email Field */}
