...
// AdminApplicationTracker.tsx - HORIZONTAL SCROLL VERSION
"use client";
import Image from "next/image";
import { useEffect, useState } from "react";
import { Save, CheckCircle, GraduationCap, X, AlertCircle } from "lucide-react";
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-600">
                  {APPLICATION_STEPS.find((step) => step.id === currentStatus)?.label}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm text-gray-700">
          <div className="flex items-center gap-2">
            ...
            <span className="truncate">
              {courseData.countryname || courseData.countryOfStudy || "Country not specified"}
            </span>
          </div>
          <div className="flex items-center gap-2">
            <Image src="/DashboardPage/intake.svg" width={14} height={14} alt="Intake" />
            <span className="truncate">
              {Array.isArray(courseData.intake)
                ? courseData.intake.join(", ")
                : courseData.intake || "Not specified"}
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="truncate">{courseData.duration || "Not specified"}</span>
          </div>
          <div className="flex items-center gap-2">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between relative">
            ...
            <div
              ...
              style={{
                width: `${((Math.min(localStatus, currentStatus) - 1) / (APPLICATION_STEPS.length - 1)) * 100}%`,
              }}
            />
