...
//               <div className="w-12 h-12 bg-gradient-to-br from-yellow-500 to-red-600 rounded-full flex items-center justify-center">
...
//               </div>
//             </div>
//             <div className="bg-gradient-to-r from-yellow-500 to-red-600 text-white px-6 py-3 rounded-lg">
...
//               >
//                 <Card className="h-full transition-all duration-200 hover:shadow-lg hover:-translate-y-1 border-2 hover:border-yellow-200 group-hover:bg-gradient-to-br group-hover:from-white group-hover:to-yellow-50">
//                   <CardHeader className="pb-3">
//                     <div className="flex items-start justify-between">
//                       <div className="flex-1">
//                         <CardTitle className="text-lg font-semibold text-gray-900 group-hover:text-yellow-700 transition-colors line-clamp-1">
