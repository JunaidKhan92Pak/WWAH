        ...
        <div className="space-y-4">
          ...
          {userBasics && (
            <div className="border-b pb-2">
              ...
              <p>
                <strong>hasStudiedAbroad:</strong> {userBasics.hasStudiedAbroad}
              </p>
              <p>
          ...
          {userApplication && (
            <div>
              ...
              <p>
                <strong>speakingScore:</strong> {userApplication.speakingScore}
              </p>
              <p>
              ...
              {(workExperience ?? []).map((workExperience, i) => (
                <div key={i}>
                  ...
                  <p>
                    <strong>from:</strong> {workExperience.from}
                  </p>
                  <p>
                    <strong>to:</strong> {workExperience.to}
                  </p>
                </div>
              ))}
            </div>
